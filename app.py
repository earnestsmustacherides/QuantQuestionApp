...
class CustomDialog(simpledialog.Dialog): 
    ...
    def body(self, master): 
        ...
        self.label = tk.Label(master, text = "Please click the hyperlink below to be taken to the question, your timer will start automatically.\n Alternatively, click Start Timer below to be taken to the webpage.")
        self.label.pack()
...
class TopMessageWindow(tk.Toplevel): 
    def __init__(self, parent, title, message, question): 
        ...
        self.notes_entry = tk.Text(self, height=10, width=50)
        ...
        self.review_button = tk.Button(self, text="Review", command=self.review, height = 4)
        self.review_button.pack(anchor = tk.SW, side = tk.BOTTOM, padx = 5)
    def toggle_bookmark_img(self):
